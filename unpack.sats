...
macdef MSGPACK_UNPACK_SUCCESS     = $extval (msgpack_unpack_return, "MSGPACK_UNPACK_SUCCESS")
macdef MSGPACK_UNPACK_EXTRA_BYTES = $extval (msgpack_unpack_return, "MSGPACK_UNPACK_EXTRA_BYTES")
macdef MSGPACK_UNPACK_CONTINUE    = $extval (msgpack_unpack_return, "MSGPACK_UNPACK_CONTINUE")
macdef MSGPACK_UNPACK_PARSE_ERROR = $extval (msgpack_unpack_return, "MSGPACK_UNPACK_PARSE_ERROR")
macdef MSGPACK_UNPACK_NOMEM_ERROR = $extval (msgpack_unpack_return, "MSGPACK_UNPACK_NOMEM_ERROR")
...
//#endif
macdef MSGPACK_UNPACKER_INIT_BUFFER_SIZE = $extval (int, "MSGPACK_UNPACKER_INIT_BUFFER_SIZE")
...
fun msgpack_unpacker_next (unpacker: !msgpack_unpacker, obj: &msgpack_unpacked): msgpack_unpack_return = "#mac"
